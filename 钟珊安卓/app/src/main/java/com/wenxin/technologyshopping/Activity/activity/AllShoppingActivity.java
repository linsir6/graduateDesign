...
import com.wenxin.technologyshopping.Activity.adapter.WashAdapter;
import com.wenxin.technologyshopping.Activity.fragment.FragmentCloth;
import com.wenxin.technologyshopping.Activity.fragment.FragmentShose;
import com.wenxin.technologyshopping.Activity.fragment.FragmentTrousers;
import com.wenxin.technologyshopping.R;

import java.util.ArrayList;

/**
 * Created by linSir on 17/3/6.所有商品的界面
 */
public class AllShoppingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_all_shopping);
        initTextView();
        InitTextBar();
        InitViewPager();
    ...
    private void InitViewPager() {
        ...
        FragmentCloth cloths = new FragmentCloth();
        FragmentTrousers trousers = new FragmentTrousers();
        FragmentShose shoses = new FragmentShose();

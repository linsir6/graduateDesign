...
public class FragmentShoppingCar extends android.support.v4.app.Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_laundry, null);
    ...
    public void setUserVisibleHint(boolean isVisible) {
        if (isVisible) {
            if (MyApplication.washJavas.size() == 0 && fg_laundry_list != null) {
                ...
                fragment_laundry_item1 = View.inflate(getActivity(), R.layout.fragment_laundry_item1, null);

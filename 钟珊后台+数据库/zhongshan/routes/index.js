...
// router.get('/add_order_list', function (req, res, next) {
//     // 从连接池获取连接
//     pool.getConnection(function (err, connection) {
// // 获取前台页面传过来的参数
//         var param = req.query || req.params;
...
//         var add = "INSERT INTO order_list(unumber,number,items,address,phone,price,count,buyer,order_date) VALUES(?,?,?,?,?,?,?,?,?)";
//         connection.query(add, [unumber, number, items, address, phone, price, count, buyer, order_date], function (err, result) {
//             if (err) {
//                 console.log(err);
//                 console.log("添加失败");
//             } else {
